...
class TestDatabaseLoader:
    ...
    def test_load_problem_validation_warnings(
        self, mock_logger, mock_create_client, mock_optimized_create_client
    ):
    ...
    @patch("src.data.loaders.optimized_database.create_client")
    @patch("src.data.loaders.database.create_client")
    def test_data_associations(self, mock_create_client, mock_optimized_create_client):
    ...
    @patch("src.data.loaders.optimized_database.create_client")
    @patch("src.data.loaders.database.create_client")
    def test_timezone_handling(self, mock_create_client, mock_optimized_create_client):
