...
class ServiceRoleManager:
    ...
    @property
    def service_client(self) -> Client | None:
    ...
    def is_available(self) -> bool:
        ...
        return (
            ...
            and self.service_role_key is not None
    ...
    def escalate_for_database_operation(
        self, operation: str, table_name: str, user_context: dict | None = None
    ) -> Client | None:
    ...
    def escalate_for_solver_operation(
        self, solver_operation: str, user_context: dict | None = None
    ) -> Client | None:
    ...
    def validate_service_role_permissions(self) -> dict[str, bool]:
        ...
        try:
            ...
            result = (
                self.service_client.table("job_optimized_patterns")
                .select("*")
                .limit(1)
                .execute()
            )
...
_service_role_manager: ServiceRoleManager | None = None
