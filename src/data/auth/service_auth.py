...
class ServiceAuthManager:
    ...
    def _load_config(self) -> ServiceAuthConfig:
        ...
        return ServiceAuthConfig(
            ...
            enable_auth_bypass=os.getenv('NODE_ENV') == 'development' and 
                             os.getenv('NEXT_PUBLIC_DISABLE_AUTH') == 'true',
    ...
    def get_table_data(self, table: str, filters: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
...
def execute_service_query(query: str, params: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
