...
export default function JobInstanceForm() {
  ...
  const handleEdit = (instance: JobInstance) => {
    ...
    setValue('pattern_id', instance.pattern_id)
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            {editingId ? 'Update job instance information' : 'Create a new job instance based on an optimized pattern'}
          </CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="flex justify-end space-x-2 pt-4">
              ...
              <Button type="submit" disabled={isSubmitting || !watch('pattern_id')}>
                  ...
                  {jobInstances.map((instance: any) => {
                    ...
                    return (
                      <tr key={instance.instance_id} className="border-b hover:bg-gray-50">
                        ...
                        <td className="p-2">{instance.job_optimized_patterns?.name || 'Unknown'}</td>
